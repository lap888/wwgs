...
namespace Gs.Core
{
    ...
    public static class SystemLog
    {
        ...
        static readonly ILoggerRepository fileLogger = LogManager.CreateRepository("FileLogs");
        ...
        static string GetMethodFullName()
        {
            ...
            {
                if (!fileLoggerActive) { FileLoggerConfigure(); }
                LogManager.GetLogger(fileLogger.Name, $"Gs.Core.{nameof(GetMethodFullName)}").Fatal(ex);
                return string.Empty;
            }
        }
        #endregion
