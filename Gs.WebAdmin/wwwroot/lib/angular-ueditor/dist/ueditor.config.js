...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [['fullscreen', 'undo', 'redo', '|',
            ...
            'simpleupload', /*'insertimage', 'emotion', 'scrawl',  'music', 'pagebreak', 'template', 'background', '|',*/
            /*'horizontal', 'inserttable', 'deletetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols',*/
            '|', 'source'
        ]]
        ...
        //, iframeCssUrl: 'css/ueditor.css' ///themes/iframe.css给编辑区域的iframe引入一个css文件
        ...
        , catcherUrlPrefix: 'ue_separate_ue'
        //pageBreakTag
