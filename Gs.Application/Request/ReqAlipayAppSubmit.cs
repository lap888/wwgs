...
namespace Gs.Application.Request
{
    ...
    public class ReqAlipayAppSubmit : IAlipayRequest<AlipayResult<Response.RspAlipayAppSubmit>>
    {
        ...
        /// 业务扩展参数
        /// </summary>
        public AliDictionary ExtendParams { get; set; }
        ...
        /// </summary>
        public AliDictionary BusinessParams { get; set; }

        /// <summary>
        /// 签约参数。如果希望在sdk中支付并签约，需要在这里传入签约信息。
        /// </summary>
        public AliDictionary AgreementSignParams { get; set; }

        /// <summary>
        /// 订单包含的商品列表信息，json格式，其它说明详见商品明细说明
        /// </summary>
        public List<AliDictionary> GoodsDetail { get; set; }

        /// <summary>
        /// 外部指定买家
        /// </summary>
        public AliDictionary ExtUserInfo { get; set; }
        ...
        /// </summary>
        /// <returns></returns>
        public AliDictionary GetPublicParam()
        {
            AliDictionary PublicParam = new AliDictionary();
        ...
        /// </summary>
        /// <returns></returns>
        public AliDictionary GetParam()
        {
            AliDictionary Param = new AliDictionary();
            ...
            Param.Add("passback_params", this.PassbackParams);
