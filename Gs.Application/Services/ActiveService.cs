...
namespace Gs.Application.Services
{
    ...
    {
        private readonly String CacheLockKey = "ActiveAccount:";
        private readonly String AccountTableName = "user_account_active";
        private readonly String RecordTableName = "user_account_active_record";

        private readonly WwgsContext context;
        private readonly CSRedisClient RedisCache;
        public ActiveService(WwgsContext mysql, CSRedisClient redisClient)
        {
            context = mysql;
        ...
        public async Task<MyResult<List<AccountRecord>>> Records(QueryModel query)
        {
            ...
            {
                ActiveModifyType ModifyType = (ActiveModifyType)item.ModifyType;
        ...
        /// <returns></returns>
        public async Task<Boolean> ChangeAmount(Int64 Uid, Decimal Amount, ActiveModifyType ModifyType, Boolean UseFrozen, params string[] Desc)
        {
