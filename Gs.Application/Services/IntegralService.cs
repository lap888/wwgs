...
namespace Gs.Application.Services
{
    ...
    {
        private readonly String CacheLockKey = "IntegralAccount:";
        private readonly String AccountTableName = "user_account_integral";
        private readonly String RecordTableName = "user_account_integral_record";

        private readonly WwgsContext context;
        private readonly CSRedisClient RedisCache;
        public IntegralService(WwgsContext mysql, CSRedisClient redisClient)
        {
            context = mysql;
        ...
        public async Task<MyResult<List<AccountRecord>>> Records(QueryModel query)
        {
            ...
            {
                IntegralModifyType ModifyType = (IntegralModifyType)item.ModifyType;
        ...
        /// <returns></returns>
        public async Task<Boolean> ChangeAmount(Int64 Uid, Decimal Amount, IntegralModifyType ModifyType, Boolean UseFrozen, params string[] Desc)
        {
