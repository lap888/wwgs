...
namespace Gs.Application.Services
{
    ...
    {
        private readonly String CacheLockKey = "HonorAccount:";
        private readonly String AccountTableName = "user_account_honor";
        private readonly String RecordTableName = "user_account_honor_record";

        private readonly WwgsContext context;
        private readonly CSRedisClient RedisCache;
        public HonorService(WwgsContext mysql, CSRedisClient redisClient)
        {
            context = mysql;
        ...
        public async Task<MyResult<List<AccountRecord>>> Records(QueryModel query)
        {
            ...
            {
                HonorModifyType ModifyType = (HonorModifyType)item.ModifyType;
        ...
        /// <returns></returns>
        public async Task<Boolean> ChangeAmount(Int64 Uid, Decimal Amount, HonorModifyType ModifyType, Boolean UseFrozen, params string[] Desc)
        {
