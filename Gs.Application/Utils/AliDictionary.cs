...
namespace Gs.Application.Utils
{
    ...
    /// 键值对
    /// </summary>
    public class AliDictionary : Dictionary<String, String>
    {
        public AliDictionary() { }

        public AliDictionary(IDictionary<String, String> dictionary) : base(dictionary) { }
        ...
        public void Add(String key, Object value)
        {
            ...
            else if (value is AliDictionary || value is List<AliDictionary>)
            {
                strValue = JsonConvert.SerializeObject((value as AliDictionary));
            }
